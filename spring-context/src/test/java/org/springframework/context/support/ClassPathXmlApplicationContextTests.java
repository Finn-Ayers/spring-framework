...
import org.springframework.tests.sample.beans.circular.CircularA;
...
public class ClassPathXmlApplicationContextTests {
	...
	public void applicationContextTest() {
		FileSystemXmlApplicationContext ftx = new FileSystemXmlApplicationContext("E:\\BeanFactoryUtilsTests-leaf.xml");
		CircularA circularA = (CircularA) ftx.getBean("circularA");
		System.out.println("姓名:" + circularA.getName() + ",年龄: " + circularA.getAge());
	}
