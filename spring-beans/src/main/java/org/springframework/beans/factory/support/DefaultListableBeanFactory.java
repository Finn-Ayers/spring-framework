	...
	public void registerBeanDefinition(String beanName, BeanDefinition beanDefinition)
		...
		if (existingDefinition != null) {
			...
			if (!isAllowBeanDefinitionOverriding()) {
				...
				// 覆盖 beanDefinition 大于 被覆盖的 beanDefinition 的 ROLE,打印info日志
				...
				// 覆盖 beanDefinition 与 被覆盖的 beanDefinition 不相同,打印debug日志
			...
			// 允许覆盖，直接覆盖原有的 BeanDefinition 到 beanDefinitionMap中
			...
			if (hasBeanCreationStarted()) {
				...
				// beanDefinitionMap 为全局变量,避免并发情况所以加锁处理
				...
				// 添加到 BeanDefinition 到 beanDefinitionMap中
				this.beanDefinitionMap.put(beanName, beanDefinition);

				// 添加 beanName 到 beanDefinitionNames中
